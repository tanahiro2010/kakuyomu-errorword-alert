...
button.onclick = (async () => {
    ...
    const contentElement: HTMLDivElement | null = document.querySelector('.widget-episodeBody.js-episode-body');
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const response = await fetch(`${apiBaseUrl}/works/${workId}/episodes/${episodeId}/errors/new`, {
            method: 'POST',
            body: formData
        });
